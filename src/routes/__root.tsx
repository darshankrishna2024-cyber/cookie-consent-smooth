  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <Link to="/" className="mt-6 inline-block border border-gold px-6 py-3 text-xs uppercase tracking-[0.2em] text-gold">
          Return home
        </Link>
      </div>
    </div>
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <button
          ...
          className="mt-6 border border-gold px-6 py-3 text-xs uppercase tracking-[0.2em] text-gold"
        >
          Try again
        </button>
      </div>
